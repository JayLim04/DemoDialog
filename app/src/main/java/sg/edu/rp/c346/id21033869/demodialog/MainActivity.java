package sg.edu.rp.c346.id21033869.demodialog;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnDemo4 = findViewById(R.id.btnExercise4);
        btnDemo5 = findViewById(R.id.btnExercise5);
        ...
        btnDemo5.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                @Override
                public void onTimeSet(TimePicker view,int hourOfDay +":"+minute);
